Config = {
  ...
  KeyMapping = "NUMPAD6",         -- The key to open the Admin Menu.
  ...
  PermissionSystem = {
    ...
    {
      AcePerm = "exory.owner", -- Will only utilize this if you don't have the UseDiscordRestAPI bool enabled
    ...
    {
      AcePerm = "exory.moderator", -- Will only utilize this if you don't have the UseDiscordRestAPI bool enabled
      RoleID = "",                  -- Only works if you have UseDiscordRestAPI bool enabled and you have your Bot Token and Guild ID configured in sv_config.lua .
      AllowedPermissions = {
        Menu = true,
        Kick = true,
