...
-- lib.callback.register('ceadmin:plist', function(source)
--   return PlayerList
-- end)

-- lib.callback.register("ceadmin:clist", function(source)
--   return PlayerCache
-- end)

-- lib.callback.register("ceadmin:getPermissions", function(source)
